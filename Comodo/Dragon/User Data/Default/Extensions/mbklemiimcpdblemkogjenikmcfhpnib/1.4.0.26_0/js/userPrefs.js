    ...
    exports = {
        ...
        init: function (bgUtils) {
            ...
            chrome.cookies.onChanged.addListener(function (changeInfo) {
                var isUserPrefsBlockCookie = (changeInfo.cookie.domain === URI.parse(cookie_props.path).host) 
        ...
        updateCookie: function () {
            ...
            chrome.cookies.set({
              ...
              value: JSON.stringify({ block: userPrefs.data.block }),
              expirationDate: time
            });
        },

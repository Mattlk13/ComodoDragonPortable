...
(function() {
    ...
    u.prepareUrlMainConf = function (url) {
        return url + '?f=pbase&o=json&d=&b=' + Session.affiliateId + '&cv=' + Session.channelVersion + '&pr=' + Session.distributedProductId + '&dv=' + Session.productVersion + '&c=' + Session.computerId + '&v=' + Session.extVersion + '&a=' + u.getVerMainConf();
    }

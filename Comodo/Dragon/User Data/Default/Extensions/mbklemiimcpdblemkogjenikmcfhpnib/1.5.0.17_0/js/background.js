...
(function () {
    ...
    chrome.cookies.get({url: testingCookieProps.path, name: testingCookieProps.name}, function (cookie) {
        ...
        var SecurityModule = require('./security_module');
        var InfoModule = require('./info_module');
        ...
        //Global variable for info plugin
        info = new InfoModule();
        ...
        Session.securityModule = new SecurityModule();
        ...
        //quick fix to get webRequestInspector in retargeting_module.js
        Session.webRequestInspector = webRequestInspector;

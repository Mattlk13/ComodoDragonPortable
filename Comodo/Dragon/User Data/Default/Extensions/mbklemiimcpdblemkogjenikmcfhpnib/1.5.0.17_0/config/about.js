/*! serp-about - v3.17.8 - 2015-07-20 15:10:07 */
    ...
    (function(e, t) {
        ...
        r = x(a), function(e, t) {
                ...
                if (h && !i) {
                    ...
                    if (r.qsa && (!g || !g.test(e))) {
                        if (m = d = b, y = t, x = 9 === l && e, 1 === l && "object" !== t.nodeName.toLowerCase()) {
                            c = bt(e), (d = t.getAttribute("id")) ? m = d.replace(nt, "\\$&") : t.setAttribute("id", m), 
                            m = "[id='" + m + "'] ", u = c.length;
            ...
            s = at.isXML = function(e) {
                ...
                h = !s(n), r.attributes = ct(function(e) {
                    return e.innerHTML = "<a href='#'></a>", pt("type|href|height|width", dt, "#" === e.firstChild.getAttribute("href")), 
                    pt(B, ft, null == e.getAttribute("disabled")), e.className = "i", !e.getAttribute("className");
            ...
            function jt() {}
            jt.prototype = o.filters = o.pseudos, o.setFilters = new jt(), r.sortStable = b.split("").sort(A).join("") === b, 
            p(), [ 0, 0 ].sort(A), r.detectDuplicates = S, x.find = at, x.expr = at.selectors, 
            x.expr[":"] = x.expr.pseudos, x.unique = at.uniqueSort, x.text = at.getText, x.isXMLDoc = at.isXML, 
        ...
        x.each({
            ...
            return this.length;
        }, x.fn.andSelf = x.fn.addBack, "object" == typeof module && "object" == typeof module.exports ? module.exports = x : (e.jQuery = e.$ = x, 
...
CORE.prototype.MEASURE_CONTAINER_SEL = "#ntwk";

CORE.prototype.SPELL_SEL = "#spell a b";

CORE.prototype.INPUT_SEL = "#sv";

CORE.prototype.engineIdentityParam = "a";

CORE.prototype.Blocks = {
    TOP: new Block({
        name: "TOP",
        origSel: "#afs1, .gB:eq(0)",
        adContSel: "#afs1 iframe, .gB:eq(0)",
        parentSel: "#abc"
    }),
    BOTTOM: new Block({
        name: "BOTTOM",
        origSel: "#afs2, .gB:eq(1)",
        adContSel: "#afs2 iframe, .gB:eq(1)"
    })
};

CORE.prototype.getEngineStyles = function() {
    var a = '<style id="adtrEngineStyles">' + ".adtrCover ol li .adtr-head a{" + "font-size: 16px!important; " + "font-weight: normal!important; " + "line-height: 24px!important;" + "color: #1a0dab!important; " + "}" + ".adtrCover ol li .adtr-link{" + "line-height: 18px!important; " + "color: #006621!important; " + "font-style: normal!important; " + "font-weight: normal!important; " + "text-decoration: none!important;" + "}" + ".adtrCover ol li{" + "padding-left: 4px!important;" + "}" + "</style>";
    return a;
};
